export default [
  {
    ...
    "goal": "database",
    "description": "Dilation of Left Peroneal Artery, Bifurcation, with Three Drug-eluting Intraluminal Devices, Open Approach",
    "sections":[
      {
        "name": "Rank",
  ...
  {
    "id": "9942d05b-df17-442e-934a-75b263f411e2",
    "name": "Gecko, tokay",
    "goal": "Operative",
    "description": "Plain Radiography of Right Subclavian Vein using High Osmolar Contrast",
    "sections": [
      {
        "name": "Prodder",
        "projects": ["Calculator"],
    ...
    "createdAt":"6:25","updatedAt":"22:02"
  },
  ...
  {"id":"ed63e692-ab37-43ab-9f2c-3ca273017160","name":"Black-winged stilt","goal":"algorithm","description":"Drainage of Left Carpal Joint with Drainage Device, Open Approach",
    "sections":[
      { 
        "name":"Tin",
        "projects": ["Calculator"], 
  ...
  {
    "id": "c49fd2b3-11b5-4cc8-9a08-c132c3bfdffd",
    "name": "Rattlesnake, dusky",
    "goal": "Balanced",
    "description": "Detachment at Left Foot, Complete 3rd Ray, Open Approach",
    "sections": [
      {
        "name": "Gembucket",
        "projects": ["Calculator","Calculator"],
        "resources": ["Calculator","Calculator","Calculator"]
      }, 
      {
        "name":"Bitchip",
        "projects":["Calculator"],
  ...
  {
    "id": "f29835cb-7907-4da6-a22a-951882d5e418",
    "name": "Alligator, mississippi",
    "goal": "regional",
    "description": "Revision of Autologous Tissue Substitute in Heart, External Approach",
    "sections": [
      {
        "name": "Zaam-Dox", 
        "projects": ["Calculator"],
      ...
      },
      {
        "name":"Greenlam",
        "projects":["Calculator"],
        "resources":["Calculator","Calculator","Tic Tac Toe"]
      },
      {
        "name": "Span",
        "projects": ["Calculator"],
